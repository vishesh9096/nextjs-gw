  ...
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    <div class=" lg:flex-row lg:justify-between items-center bg-gray-100 rounded-lg p-4 sm:p-8">
      ...
      <div class=" items-center ">
        <form onSubmit={notify} class="w-full items-center max-w-md space-y-3 gap-2 mb-3">
          ...
          <button  class="inline-block  bg-[#497A3E] hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded outline-none  px-8 py-2">Notify me of next batch details </button>
